...
assert.ok(app.includes("./pages/result-comments.js?v=20260906-result-clean-1"), '원문보기 결과 모듈이 최종 감사 버전이어야 합니다.');
...
assert.ok(serviceWorker.includes('/js/pages/result-comments.js?v=20260906-result-clean-1'), '서비스워커가 기준 원문보기 결과 모듈을 캐시해야 합니다.');
