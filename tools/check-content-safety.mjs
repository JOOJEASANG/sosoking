...
const allowedCases = [
  ...
  '친구 2명과 같이 식당에 가서 냉면을 먹었는데 너무 시큼해서 사장님을 호출했습니다.',
  '선생님께서 원래 그런 맛이라고 설명하셨습니다.',
  '기사님에게 목적지를 다시 말씀드렸습니다.',
  '고객님과 점장님이 서로 다른 이야기를 했습니다.',
  '아저씨가 먼저 줄을 섰고 아가씨는 뒤에서 기다렸습니다.'
];
...
const blockedCases = [
  ...
  ['홍길동님이 직접 말했다고 합니다.', 'person-name-honorific'],
  ['철수씨가 제 물건을 가져갔습니다.', 'person-name-honorific'],
  ['영희양은 먼저 도착했습니다.', 'person-name-honorific'],
