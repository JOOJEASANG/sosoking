...
need(app, "import { renderHome } from './pages/home.js?v=20260911-home-services-1';", 'application modules');
...
need(worker, '/js/pages/home.js?v=20260911-home-services-1', 'active application cache');
for (const retired of ['home-seven-judges.js', 'home-no-search.js', 'home-court.js', 'home-judge-assignment.js']) {
