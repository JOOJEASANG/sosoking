...
for (const file of ['public/game/fun-pack.js', 'public/game/fun-reset.js']) {
...
console.log('Game fun pack validation passed: audio, haptics, missions, powers, replay recharge, random events, betting, awards, and four-game series are wired to all live games.');
