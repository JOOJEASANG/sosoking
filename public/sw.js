const CACHE_NAME = 'sosoking-app-v20260802-remove-daily-court-1';
...
const APP_SHELL = [
  ...
  '/css/brand-logo.css?v=20260802-remove-daily-court-1',
  ...
  '/js/app.js?v=20260802-remove-daily-court-1',
