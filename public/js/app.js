...
function injectDesktopHeaderStyle() {
  ...
  style.textContent = `
    ...
    .soso-dashboard-header{display:none;position:fixed;left:0;right:0;top:0;height:78px;z-index:520;align-items:center;gap:26px;padding:10px 34px;border-bottom:2px solid transparent;background:rgba(255,255,255,.94);box-shadow:0 0 0 1px rgba(124,92,255,.18),0 12px 40px rgba(25,35,70,.12);background-clip:padding-box;backdrop-filter:blur(22px) saturate(1.25);-webkit-backdrop-filter:blur(22px) saturate(1.25)}
    .soso-top-brand{display:flex;align-items:center;gap:11px;min-width:210px;color:#10172f;text-decoration:none}.soso-top-brand img{width:48px;height:48px;border-radius:10px;background:#fff;box-shadow:0 6px 18px rgba(100,60,220,.22)}.soso-top-brand b{display:block;font-size:26px;line-height:1;font-weight:1000;letter-spacing:-.08em;background:linear-gradient(100deg,#2a0e88,#6a28ee,#e040a0);-webkit-background-clip:text;background-clip:text;color:transparent}.soso-top-brand span{display:block;margin-top:3px;color:#6b7280;font-size:11px;font-weight:1000;letter-spacing:-.02em}.soso-top-links{display:flex;align-items:center;gap:4px;justify-content:center;flex:1}.soso-top-links a{position:relative;padding:11px 14px;border-radius:5px;color:#171e3b;text-decoration:none;font-size:14px;font-weight:1000;letter-spacing:-.04em}.soso-top-links a:hover{background:rgba(70,100,220,.07)}.soso-top-links a.active{color:#4a20c8}.soso-top-links a.active:after{content:'';position:absolute;left:14px;right:14px;bottom:5px;height:2px;border-radius:2px;background:linear-gradient(90deg,#4a20c8,#e040a0)}.soso-top-tools{display:flex;align-items:center;justify-content:flex-end;gap:9px;min-width:390px}.soso-top-search{display:flex;align-items:center;gap:8px;width:220px;height:42px;padding:0 12px;border:1px solid rgba(70,100,220,.13);border-radius:6px;background:#fff;box-shadow:0 3px 12px rgba(50,80,160,.05)}.soso-top-search input{width:100%;border:0;outline:0;background:transparent;color:#151a33;font-family:inherit;font-weight:800}.soso-top-search button{border:0;background:transparent;font-size:17px;cursor:pointer}.soso-top-install{height:42px;border:0;border-radius:6px;padding:0 16px;background:linear-gradient(135deg,#e040a0,#6a28ee,#2040ee);color:#fff;font-weight:1000;font-family:inherit;box-shadow:0 8px 22px rgba(100,40,220,.28);cursor:pointer;white-space:nowrap}.soso-top-avatar{display:flex;align-items:center;gap:7px;border:0;background:transparent;color:#151a33;cursor:pointer}.soso-top-avatar i{font-style:normal;width:40px;height:40px;border-radius:6px;background:linear-gradient(135deg,#ffe85c,#ff9040,#6a28ee);display:flex;align-items:center;justify-content:center;font-size:20px;box-shadow:0 6px 18px rgba(50,80,160,.12)}.soso-top-avatar span{font-size:17px;color:#6d7588}
