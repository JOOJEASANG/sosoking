...
import { renderSubmit } from './pages/submit-guard.js?v=20260708-simple1';
import { renderTrial } from './pages/trial-game.js?v=20260708-investigation1';
import { renderResult } from './pages/result-court.js?v=20260708-drama1';
import { renderPolicy } from './pages/policy.js?v=20260708-policy1';
import { renderMyCases } from './pages/my-cases-game.js?v=20260708-delete1';
