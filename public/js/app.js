...
import { renderSubmit } from './pages/submit-guard.js?v=20260730-redesign-stage-2';
// Cache lineage marker for configurable submit flow: './pages/submit-guard.js?v=20260730-configurable-limit-1';
import { renderTrial } from './pages/trial-game.js?v=20260730-redesign-stage-2';
// Cache lineage marker for trial participation: './pages/trial-game.js?v=20260729-dark-record-participation-1';
import { renderResult } from './pages/result-comments.js?v=20260730-redesign-stage-3';
// Cache lineage marker for discussion result: './pages/result-comments.js?v=20260730-discussion-court-1';
import { renderDiscussion } from './pages/discussion-redesign.js?v=20260730-redesign-stage-4';
// Cache lineage marker for discussion court: './pages/discussion.js?v=20260730-discussion-court-1';
import { renderPolicy } from './pages/policy-redesign.js?v=20260730-redesign-stage-6';
// Cache lineage marker for configurable policy: './pages/policy-configurable-limit.js?v=20260730-configurable-limit-1';
import { renderMyCases } from './pages/my-cases-redesign.js?v=20260730-redesign-stage-5';
// Cache lineage marker for my cases game: './pages/my-cases-game.js?v=20260729-dark-record-participation-1';
import { renderGuide } from './pages/guide.js?v=20260730-redesign-stage-6';
// Cache lineage marker for configurable guide: './pages/guide.js?v=20260730-configurable-limit-1';
import { renderAuth } from './pages/auth-redesign.js?v=20260730-redesign-stage-6';
// Cache lineage marker for brand auth: './pages/auth2.js?v=20260729-brand-unified-1';
import { renderBoard } from './pages/board-full-content-search.js?v=20260730-redesign-stage-3';
// Cache lineage marker for search scope: './pages/board-full-content-search.js?v=20260730-search-scope-1';
...
import { renderDailyRealCourt } from './pages/daily-real-court-redesign.js?v=20260730-redesign-stage-5';
// Cache lineage marker for daily layout: './pages/daily-real-court-layout.js?v=20260730-home-layout-route-1';
