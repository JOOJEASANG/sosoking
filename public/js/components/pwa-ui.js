...
function styleOnce() {
  ...
  style.textContent = `
    ...
    .pwa-pill-icon{width:24px;height:24px;border-radius:8px;background:url('/app-icon.svg?v=20260702-10') center/cover no-repeat;box-shadow:0 0 0 1px rgba(255,255,255,.16);}
    ...
    .pwa-card-icon{width:82px;height:82px;border-radius:24px;background:url('/app-icon.svg?v=20260702-10') center/cover no-repeat;margin:0 auto 12px;box-shadow:0 12px 28px rgba(0,0,0,.28),0 0 0 1px rgba(212,181,92,.28);}
