      ...
      <div class="card legal-card">
        <div class="legal-body">
          <div class="legal-notice">
            소소킹은 통합 게시판, 댓글, AI 캐릭터 참여 기능을 제공하기 위해 필요한 최소한의 개인정보와 이용 데이터를 수집·이용합니다.
          </div>
          ...
          <div class="legal-table-wrap">
            <table class="legal-table">
              ...
              <tbody>
                ...
                <tr><td>게시판 이용</td><td>게시물, 사진, 댓글, 답글, 선택지, 퀴즈 정답, 드립 참여글, 리액션, 스크랩, 신고 내역</td><td>서비스 이용 중</td></tr>
                <tr><td>AI 캐릭터 기능</td><td>게시글 제목·내용·유형, 댓글 내용, 캐릭터 댓글 생성 여부, 자동 댓글 생성 로그</td><td>AI 캐릭터 댓글 생성 시</td></tr>
          ...
          <ul class="legal-list">
            ...
            <li>게시글 작성자 표시, 댓글·답글·투표·퀴즈·드립·리액션 등 커뮤니티 기능 제공</li>
            <li>일반글, 투표, 퀴즈, 드립 글쓰기 기능 제공</li>
            <li>AI 캐릭터 댓글 생성, 캐릭터별 반응 제공, 자동 댓글 중복 방지 및 운영 로그 관리</li>
            <li>익명 글의 화면상 작성자명 숨김 처리와 신고·분쟁 대응</li>
            <li>스크랩, 알림, 인기글 등 개인화 기능 제공</li>
          ...
          <ul class="legal-list">
            <li>AI 캐릭터 댓글 생성을 위해 게시글 제목, 내용, 글 유형 등 필요한 정보가 AI 처리 과정에 사용될 수 있습니다.</li>
            <li>AI 캐릭터는 사용자의 민감정보 입력을 요구하지 않으며, 민감한 개인정보는 게시글이나 댓글에 직접 입력하지 않는 것이 좋습니다.</li>
            <li>AI 캐릭터 댓글 생성 결과와 실행 로그는 품질 개선, 중복 방지, 비용 관리, 신고 대응을 위해 저장될 수 있습니다.</li>
          ...
          <ul class="legal-list">
            ...
            <li>AI 캐릭터 댓글과 생성 로그는 서비스 운영, 품질 관리, 신고 대응에 필요한 기간 보관될 수 있습니다.</li>
          ...
          <div class="legal-table-wrap">
            <table class="legal-table">
              ...
              <tbody>
                ...
                <tr><td>Anthropic 또는 기타 AI API</td><td>AI 캐릭터 댓글 생성 및 자동 응답 처리</td><td>게시글 제목·내용·유형 등 AI 응답 생성에 필요한 정보</td></tr>
