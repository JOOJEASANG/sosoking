      ...
      <div class="card legal-card">
        <div class="legal-body">
          ...
          <ul class="legal-list">
            ...
            <li>AI킹(판결소·창작소) 기능 제공 및 결과물 피드 게시</li>
          ...
          <div class="legal-table-wrap">
            <table class="legal-table">
              ...
              <tbody>
                ...
                <tr><td>Anthropic (Claude AI)</td><td>AI킹 기능(판결소·창작소) 결과 생성</td><td>입력 텍스트, 업로드 이미지(이용자가 선택한 경우)</td></tr>
                <tr><td>Google (Gemini AI)</td><td>AI킹 기능(판결소·창작소) 결과 생성</td><td>입력 텍스트, 업로드 이미지(이용자가 선택한 경우)</td></tr>
