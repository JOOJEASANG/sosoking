      ...
      <div class="card legal-card">
        <div class="legal-body">
          ...
          <div class="legal-table-wrap">
            <table class="legal-table">
              ...
              <tbody>
                ...
                <tr><td>피드 이용</td><td>게시물, 사진, 댓글, 답글, 선택지, 퀴즈 정답, 채우기 답변, 리액션, 스크랩, 신고 내역</td><td>피드 이용 중</td></tr>
          ...
          <ul class="legal-list">
            ...
            <li>피드 작성자 표시, 댓글·답글·투표·퀴즈·채우기·리액션 등 커뮤니티 기능 제공</li>
            <li>일반글, 투표/판정, OX판정, 채우기, 미친작명소, 삼행시, 퀴즈, 익명 글쓰기 기능 제공</li>
