      ...
      <div class="card legal-card">
        <div class="legal-body">
          <div class="legal-notice">
            소소킹은 AI 캐릭터 판결·창작·상담, 생활자료실, 독립 토론실과 계정 기능을 제공하는 데 필요한 최소한의 정보만 처리합니다.
            개인 AI 결과는 로그인한 이용자 본인에게만 표시되며, 공개 토론 댓글과 구분하여 관리합니다.
          </div>
          ...
          <div class="legal-table-wrap">
            <table class="legal-table">
              ...
              <tbody>
                ...
                <tr><td>자료실</td><td>자료 조회와 화면 제공에 필요한 접속·조회 기록</td><td>자료 열람 시</td></tr>
                <tr><td>토론실</td><td>찬반 선택, 댓글, 작성 시각, 작성자 UID와 닉네임</td><td>투표·댓글 참여 시</td></tr>
                <tr><td>커뮤니티·신고</td><td>공개 게시물, 댓글, 이미지, 반응, 스크랩, 신고 내역</td><td>관련 기능 이용 시</td></tr>
          ...
          <ul class="legal-list">
            ...
            <li>생활자료실의 정보 조회와 콘텐츠 운영</li>
            <li>독립 토론실의 찬반투표, 댓글, 참여 상태와 토론 순위 제공</li>
          ...
          <ul class="legal-list">
            <li>자료실용 생활정보와 토론실용 찬반 주제는 서로 별도의 서버 작업으로 하루 한 번 생성될 수 있습니다.</li>
            <li>일일 자동 생성에는 회원의 개인 AI 입력이나 비공개 결과를 사용하지 않습니다.</li>
            <li>최근 공개 콘텐츠 제목은 중복 방지를 위해 AI 생성 요청에 포함될 수 있습니다.</li>
            <li>관리자가 직접 등록한 자료와 토론은 AI 자동 생성 콘텐츠와 구분하여 표시할 수 있습니다.</li>
          </ul>
          ...
          <div class="legal-table-wrap">
            <table class="legal-table">
              ...
              <tbody>
                ...
                <tr><td>토론 댓글</td><td>다른 이용자의 대화 흐름 보호를 위해 작성자 정보를 익명 처리한 상태로 유지될 수 있습니다.</td></tr>
          ...
          <h2 class="legal-h2">6. 외부 서비스와 처리 위탁</h2>
          <div class="legal-table-wrap">
            <table class="legal-table">
              <thead><tr><th>서비스</th><th>이용 목적</th><th>처리될 수 있는 정보</th></tr></thead>
              <tbody>
                <tr><td>Google Firebase</td><td>인증, 데이터베이스, 파일 저장, 서버 기능, 호스팅</td><td>계정 정보, 서비스 이용 데이터, 토론 투표·댓글, 개인 AI 결과</td></tr>
                <tr><td>Google·카카오</td><td>소셜 로그인</td><td>로그인 제공자가 동의 범위에서 전달하는 식별·프로필 정보</td></tr>
                <tr><td>Google Gemini 또는 Anthropic</td><td>AI 판결·문장 변환·작명·상담, 일일 생활자료와 토론 주제 생성</td><td>이용자가 AI 기능에 직접 입력한 텍스트 또는 자동 콘텐츠 생성을 위한 공개 제목·생성 지시문</td></tr>
              </tbody>
            </table>
          </div>
          <p style="font-size:13px;color:var(--color-text-muted);margin-top:8px">
            AI 제공사에는 결과 생성에 필요한 정보만 전달하며, 소소킹 로그인 비밀번호나 관리용 인증 정보는 전달하지 않습니다.
          </p>

          <h2 class="legal-h2">7. 쿠키와 로컬 저장소</h2>
          <ul class="legal-list">
          ...
          <h2 class="legal-h2">8. 이용자의 권리</h2>
          <ul class="legal-list">
            ...
            <li>공개 토론 댓글 삭제가 별도로 필요한 경우 서비스 내 문의 또는 신고 기능으로 요청할 수 있습니다.</li>
          </ul>

          <h2 class="legal-h2">9. 보호 조치</h2>
          <ul class="legal-list">
            <li>Firebase 인증과 보안 규칙을 통해 이용자별 데이터 접근을 제한합니다.</li>
            <li>개인 AI 결과는 서버 함수에서 인증된 UID를 기준으로 저장·조회·삭제합니다.</li>
            <li>자료·토론 생성과 참여 데이터 변경은 서버 함수에서 검증합니다.</li>
            <li>AI 제공사 인증 정보는 공개 데이터베이스나 프런트엔드 코드가 아닌 관리형 비밀 저장소에서 사용합니다.</li>
            <li>토론 댓글과 AI 결과 저장에는 횟수 제한과 입력 길이 검사를 적용합니다.</li>
            <li>관리자 기능은 별도 권한이 확인된 계정에만 제공합니다.</li>
          </ul>

          <h2 class="legal-h2">10. 개인정보 관련 문의</h2>
          <ul class="legal-list">
