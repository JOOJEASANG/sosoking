...
function renderIntro() {
  ...
  return `
    <section class="home-onboard">
      ...
      <div class="home-ai-grid" aria-label="참여 AI 캐릭터">
        ${residents.map(resident => `
          <div class="home-ai-card">
            <div class="home-ai-card__title"><span class="home-ai-card__emoji" aria-hidden="true">${resident.emoji}</span><span class="home-ai-card__name">${escHtml(resident.name)}</span></div>
            <div class="home-ai-card__role">${escHtml(resident.role)}</div>
          </div>`).join('')}
      </div>
    </section>`;
}
