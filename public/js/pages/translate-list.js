    ...
    <div class="tll-page">
      ...
      <div class="container" style="padding-top:18px;">
        <div style="margin-bottom:14px;">
          <div style="font-family:var(--font-serif);font-size:19px;font-weight:900;color:var(--gold);margin-bottom:6px;">💥 병맛 번역 게시판</div>
          <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;">
            <p style="font-size:12.5px;color:var(--cream-dim);margin:0;line-height:1.5;">좋아요·댓글로 반응해 보세요.</p>
            <a href="#/translate-new" class="btn btn-primary" style="flex-shrink:0;white-space:nowrap;width:auto;padding:10px 18px;font-size:14px;">+ 번역하기</a>
          </div>
        </div>
