          ...
          <form id="signup-form">
            ...
            <div class="form-group" style="margin-bottom:20px;">
              <div style="display:flex;gap:8px;">
                ...
                <button type="button" id="check-nick-btn" class="btn btn-secondary" style="flex-shrink:0;padding:0 14px;font-size:13px;">중복확인</button>
              </div>
    ...
    <div class="modal-backdrop">
      <div class="modal-box">
        ...
        <div style="display:flex;gap:8px;margin-bottom:8px;">
          ...
          <button id="modal-nick-check" class="btn btn-secondary" style="flex-shrink:0;padding:0 14px;font-size:13px;">중복확인</button>
        </div>
