...
import { renderSubmit as renderSubmitForm } from './submit-court.js?v=20260708-submit1';
    ...
    <div>
      ...
      <div class="container" style="padding-top:24px;padding-bottom:90px;">
        <div class="court-shell" style="padding:26px 22px;text-align:center;">
          ...
          <div class="court-title" style="margin-bottom:8px;">로그인 후 황당사건을 접수할 수 있습니다</div>
          <div class="court-desc" style="margin-bottom:22px;">
            내 사건 기록, 황당판결문 확인, 공개 여부 관리를 위해<br>
            구글 또는 이메일 로그인이 필요합니다.
          </div>
          <a href="#/auth" class="btn btn-primary">로그인하고 바로 접수하기</a>
          <a href="#/board" class="btn btn-ghost" style="margin-top:10px;">공개 황당판결 먼저 보기</a>
        </div>
      </div>
    </div>`;
}
