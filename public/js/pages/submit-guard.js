...
import { renderSubmit as renderSubmitForm } from './submit-court.js?v=20260708-simple1';
    ...
    <div>
      ...
      <div class="container" style="padding-top:24px;padding-bottom:90px;">
        <div class="court-shell" style="padding:26px 22px;text-align:center;">
          ...
          <div class="court-title" style="margin-bottom:8px;">로그인 후 소소사건을 접수할 수 있습니다</div>
          <div class="court-desc" style="margin-bottom:22px;">
            내 사건번호와 황당판결문을 저장하기 위해<br>
