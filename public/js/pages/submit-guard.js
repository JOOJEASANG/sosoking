...
import { renderSubmit as renderSubmitForm } from './submit-court.js?v=20260702-21';
  ...
  container.innerHTML = `
    <div>
      <div class="page-header">
        ...
        <span class="logo">한 줄 소소사건 접수</span>
      </div>
      <div class="container" style="padding-top:24px;padding-bottom:90px;">
        <div class="court-shell" style="padding:26px 22px;text-align:center;">
          ...
          <div class="court-title" style="margin-bottom:8px;">로그인 후 소소재판을 접수할 수 있습니다</div>
          <div class="court-desc" style="margin-bottom:22px;">
            내 접수 기록, 판결문 확인, 공개 여부 관리를 위해<br>
