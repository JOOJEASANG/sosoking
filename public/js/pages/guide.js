      ...
      <div class="container" style="padding-top:28px;padding-bottom:80px;">
        ...
        <div style="display:flex;flex-direction:column;gap:0;margin-bottom:36px;">
          ${[
            ...
            ['💬', '토론 (3·5·7 라운드)', '시작 전 3·5·7 라운드 중 선택합니다. 원고가 먼저 주장하고 피고가 반박하는 순서로 진행하며, 1라운드 완료 후 언제든 판결 요청 가능합니다.'],
            ['🏛️', 'AI 판결', '7가지 중 랜덤 배정된 AI 판사가 논리와 설득력만으로 판결합니다. 억울해도 논리가 부족하면 집니다. 생활형 처분도 내려집니다 😄'],
        ...
        <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:36px;">
          ${[
            ...
            ['직접 사건을 등록할 수 있나요?', '네! ✏️ 주제 등록에서 직접 등록하면 검토 후 공개됩니다. 하루 5회까지 등록 가능합니다.'],
