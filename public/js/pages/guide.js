...
const AI_KINGS = [
  {
    ...
    name: '판결소',
    path: '/ai-judge',
    desc: '억울한 상황을 적으면 6인 캐릭터 중 랜덤 3인이 각자 판결을 내립니다. 캐릭터를 직접 고를 수도 있어요!',
  ...
  },
  {
    ...
    name: '창작소',
    path: '/ai-translate',
    desc: '번역하기 + 이름짓기 두 가지를 한 곳에서! 6인 캐릭터 중 3인이 각자의 스타일로 창작합니다. 사진 속 글자도 OK.',
    examples: ['오늘 밥 먹었어? → 🙏 사이비 교주: "형제여, 몸을 위한 성찬으로 이 순간을 채우소서"', '회의 때 항상 졸는 팀장 → 👴 꼰대: "졸음극복팀장" (우리 때는 졸면 혼났어)'],
    styles: CHARS_6,
  },
  {
    emoji: '💘',
    name: '궁합소',
    path: '/ai-match',
    desc: '두 가지를 입력하면 궁합 점수 + 3인 분석 리포트를 해드립니다. 사람도 음식도 개념도 뭐든 OK.',
  ...
  },
  {
    ...
    name: '상담소',
    path: '/ai-consult',
    desc: '진지한 척 황당한 조언을 드립니다. 6인 캐릭터가 각자의 방식으로 여러분의 고민에 답합니다.',
    examples: ['직장 상사가 너무 싫어요 → 6인이 각자 솔루션 제시', '취업이 안 돼요 → 🎒 중딩: "어른들은 왜 이리 복잡하게 삶ㅋ"'],
    judges: CHARS_6,
  },
];
  ...
  el.innerHTML = `
    <div class="guide-page">
      <div class="guide-hero">
        ...
        <p class="guide-hero__sub">판결소·창작소·궁합소·상담소 — 4소(所)와 6인 캐릭터가<br>여러분의 모든 상황을 처리합니다 ㅋㅋ</p>
      </div>
      ...
      <section id="guide-what" class="guide-section">
        ...
        <div class="guide-section__body">
          ...
          <p>판결소·창작소·궁합소·상담소, 4가지 AI 서비스에서 <strong>🎒 사춘기 중딩, 🙏 사이비 교주, 🔮 예언가, 🤩 주접러, 👀 참견러, 👴 꼰대</strong> — 6인 캐릭터가 각자의 방식으로 여러분의 요청을 처리합니다.</p>
