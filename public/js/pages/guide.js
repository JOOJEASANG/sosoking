export function renderGuide(container) {
  ...
  const dailyCourtSteps = [
    ['1', '오늘의 실제 판례 읽기', '매일 실제 법원 판례 3건을 게임용으로 짧게 재구성해 보여드립니다. 결론과 사건번호는 먼저 숨겨집니다.'],
    ['2', '증거를 열고 직접 판결하기', '사건마다 최대 3개의 증거 카드를 확인한 뒤 결론을 선택합니다. 증거를 적게 열수록 정답 점수가 높습니다.'],
    ['3', '실제 판단과 민심 비교하기', '판결을 제출하면 실제 법원 판단과 이유, 이용자 선택 비율과 점수가 공개됩니다. 세 사건을 완료하면 일간 랭킹에 반영되고 주간·누적 기록도 쌓입니다.']
  ];
