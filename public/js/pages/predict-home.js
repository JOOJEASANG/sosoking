      ...
      <section class="predict-hero">
        ...
        <div class="predict-hero-inner">
          <div class="predict-hero-copy">
            ...
            <div class="predict-actions"><a href="#/predict" class="primary-action">오늘 3판 보기</a><a href="#/feed" class="secondary-action">소소피드 보기</a></div>
          </div>
...
function feedTeaser() {
  return `<section class="home-feed-teaser"><div><span>NEW · SOSO FEED</span><h2>웃긴 글, 사진, 소소한 논쟁도 쌓입니다</h2><p>검색에 남는 콘텐츠를 만들기 위해 소소피드를 추가했습니다. 사진 제목학원, 짧은 사연, 오늘의 질문에 투표와 댓글을 붙일 수 있습니다.</p></div><a href="#/feed">소소피드 보기</a></section>`;
}
