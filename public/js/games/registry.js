export const GAMES = [
  ...
  },
  {
    ...
    icon: '🧩',
    title: '소소 디펜스 랩',
    desc: '퍼즐을 맞춰 자원을 만들고, 타워·성벽·스킬로 웨이브를 막는 퍼즐 보드 디펜스 종합게임입니다.',
    status: '플레이 가능',
    tag: '🧩 전략',
    path: '/game/soso-defense',
    enabled: true,
    players: '1~4명',
    pace: '퍼즐/전략',
    hook: '퍼즐 손맛, 보드 전략, 디펜스 긴장감, 협동/대전 확장성을 한 판에 섞었습니다.',
    originalNote: '기존 게임명·캐릭터·보드 구성을 쓰지 않고, 소소킹 전용 자원 퍼즐과 웨이브 방어 규칙으로 구성합니다.',
    guide: {
      subtitle: '퍼즐로 자원을 만들고 방어선을 세우는 종합 전략 디펜스',
      goal: '같은 자원을 3개 이상 연결해 자원을 얻고, 타워·성벽·스킬을 선택해 적 진입률을 낮추며 높은 웨이브와 점수를 노립니다.',
      flow: '퍼즐 칸 교환 → 3개 이상 조합 → 자원 획득 → 타워/성벽/스킬 선택 → 웨이브 방어 → 다음 웨이브 도전 순서로 진행합니다.',
      tip: '불은 공격, 물은 성벽 재료, 나무와 돌은 건설, 번개는 타워와 스킬의 핵심 자원입니다.',
    },
  },
  {
    key: 'soso-code',
