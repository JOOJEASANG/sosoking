export const GAMES = [
  ...
  },
  {
    ...
    icon: '⚡',
    title: '심볼스파이',
    desc: '공통 심볼을 빠르게 찾는 순발력에, 목표를 모르는 스파이를 찾아내는 심리전을 섞은 오리지널 매칭 게임입니다.',
    status: '프로토타입',
    tag: '⚡ 순발력',
    ...
    players: '2~6명',
    pace: '빠른 터치',
    hook: '빨리 맞히는 사람보다 수상하게 맞히는 사람이 더 위험합니다.',
    originalNote: '상업 카드게임 이름·카드 형태·심볼 세트를 쓰지 않고, 소소킹 오리지널 심볼과 스파이 룰로 차별화합니다.',
    guide: {
      subtitle: '공통 심볼 찾기 + 숨은 스파이 추리',
      goal: '라운드마다 중앙판과 내 판의 공통 심볼을 찾습니다. 단, 일부 플레이어 또는 AI는 목표 힌트가 달라 선택 패턴으로 정체가 드러납니다.',
      flow: '심볼판 공개 → 제한시간 터치 → 정답/오답 기록 → 선택 패턴 공개 → 스파이 지목 → 점수 정산 순서로 진행합니다.',
      tip: '무조건 빠른 클릭보다 “왜 그 심볼을 골랐는지” 설명하는 단계가 핵심 재미입니다.',
    },
  },
  {
    key: 'soso-code',
