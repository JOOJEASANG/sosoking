...
const checks = [
  ...
  [actions.includes('transaction.update(resultRef') && actions.includes('transaction.delete(resultRef)'), 'Result visibility and deletion are not synchronized'],
...
console.log('Verified Stage 4 case list, status continuation, visibility controls, deletion and ownership checks.');
