...
const JUDGES = [
  ...
  },
  {
    ...
    voice: '감정 0에 가까운 건조한 문장, 손익 계산 같은 결론, 설명보다 결과를 우선하는 촌철살인'
  },
  {
    type: '회피형',
    icon: '🏃',
    style: '처음부터 왜 재판부가 이 문제까지 결정해야 하는지 난감해하며 개입을 피하려 한다. 그러나 접수된 이상 결국 판결해야 해서 이상할 정도로 최소한의 생활형 처분을 내린다.',
    voice: '관할을 떠넘기고 싶은 공문체, 건조한 난감함, 당사자끼리 먼저 해결하라는 최소개입식 결론'
  },
  {
    type: '추궁형',
    icon: '🔎',
